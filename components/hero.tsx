  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <Container className="pt-16 pb-14 md:pt-24 md:pb-20">
        <div className="grid items-start gap-10 md:grid-cols-[1fr_220px] md:gap-12">
          <div>
          ...
          <div className="order-first md:order-last">
            <div className="relative aspect-square w-40 overflow-hidden rounded-2xl border border-border bg-card md:w-full">
              <Image
