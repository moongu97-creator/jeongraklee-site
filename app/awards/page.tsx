...
export const metadata: Metadata = {
  ...
  description:
    "Awards and competitive research grants of Jeongrak Lee.",
};
...
export default function AwardsPage() {
  ...
  return (
    <>
      <PageHeader
        eyebrow="Awards & Funding"
        title="Funding and honors"
        description="Competitive research grants secured as Principal Investigator, and recognition spanning research excellence, fellowships, and entrepreneurship."
      />

      <Section
        eyebrow="Funding"
        title="Research grants & funding"
        description="Competitive grants secured as Principal Investigator."
      >
        <h3 className="mb-3 flex items-center gap-2 font-heading text-sm font-semibold uppercase tracking-wide text-muted-foreground">
          <Banknote className="h-3.5 w-3.5" /> As Principal Investigator
        </h3>
      ...
      <Section
        eyebrow="Awards"
        title="Awards & honors"
        description="All graduate honors (2021–2026) and undergraduate awards (2015–2020), grouped chronologically."
      >
        <h3 className="mb-3 flex items-center gap-2 font-heading text-sm font-semibold uppercase tracking-wide text-muted-foreground">
          <Trophy className="h-3.5 w-3.5" /> Graduate
        </h3>
        ...
        <h3 className="mt-10 mb-3 flex items-center gap-2 font-heading text-sm font-semibold uppercase tracking-wide text-muted-foreground">
          <AwardIcon className="h-3.5 w-3.5" /> Undergraduate
        </h3>
        <ol className="space-y-4">
