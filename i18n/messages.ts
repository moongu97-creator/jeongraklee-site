...
const ko: Messages = {
  ...
  home: {
    ...
    glanceBody:
      "하나의 프레임워크로 세 가지 추진을 모두 다룹니다 — 화학(현재), 플라즈마 하이브리드(근시일), 광자(장기). 화학 추진은 큐브샛과 위성군을 위한 오늘의 추력기를 발전시킵니다. 플라즈마 하이브리드는 회전 활강 아크(RGA) 추력기로 OTV·킥 스테이지가 필요로 하는 고추력(>1 N)·고비추력(>500 s) 영역을 한 번에 잡습니다. 광자 추진은 능동 박막 위에 광압 추진을 얹어, 연료 없이 장거리 항행이 가능한 솔라세일을 만듭니다.",
    researchEyebrow: "연구",
    researchTitle: "차세대 우주 추진의 세 지평",
    researchDescription:
      "오늘 바로 쓸 수 있는 화학 마이크로 추력기부터, 근시일의 플라즈마 하이브리드 시스템, 그리고 심우주 탐사를 여는 광자 추진까지.",
    pressEyebrow: "언론",
    pressTitle: "주요 보도",
  ...
  research: {
    ...
    pageDescription:
      "오늘 발사 가능한 첨단 화학 추진에서 출발해, 근시일의 전기화학 하이브리드 추진을 거쳐, 심우주 탐사를 여는 광자 추진까지.",
    metaTitle: "연구",
    metaDescription:
  ...
  awards: {
    ...
    pageTitle: "연구비와 수상",
    pageDescription:
      "주관 연구책임자로 확보한 경쟁형 연구비, 그리고 연구·펠로십·창업 영역에서 받은 수상.",
    fundingEyebrow: "연구비",
